...
public class QuartzService {
    ...
    public void initJobs() throws SchedulerException {
        // 이력서 갱신 Job
        registerJob("QuartzJob", GROUP_NAME, QuartzJob.class, "jobKoreaResumeUpdate", "0 0/10 * * * ?"); // 30분마다
        // KeepAlive Job
//        registerJob("StilALiveJob", GROUP_NAME, StilALiveJob.class, "StilALiveJob", "0 0/10 * * * ?"); // 10분마다
    }
